...
<UserControl
    x:Class="${project_namespace}.View.${curr.name?cap_first}.UsersControls.${curr.name?cap_first}RadioListUserControl"
            ...
            <ListView.ItemTemplate>
                <DataTemplate>
                    <Grid>
                        ...
                        <RadioButton IsChecked="{Binding Radio, Mode=TwoWay}" GroupName="Radioable" Grid.Column="0"/>
