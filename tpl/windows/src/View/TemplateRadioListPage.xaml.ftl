...
<Page
    x:Class="${project_namespace}.View.${curr.name?cap_first}.${curr.name?cap_first}RadioListPage"
    ...
    <ScrollViewer>
        ...
        <Grid x:Name="LayoutRoot" Background="Transparent">
            ...
            <localusercontrol:${curr.name?cap_first}RadioListUserControl x:Name="${curr.name?lower_case}_radio_list_usercontrol" Grid.Row="1"/>
        </Grid>
    </ScrollViewer>
</Page>
