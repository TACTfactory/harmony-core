...
<#if (curr.internal=="true")>
	...
	public ArrayList<${relation.type}> get${relation.type}s(final int id) {
		final ${relation.type}SQLiteAdapter adapt = new ${relation.type}SQLiteAdapter(this.context);
