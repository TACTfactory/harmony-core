...
public abstract class MenuWrapperBase {
	...
	protected abstract boolean dispatch(MenuItem item, Context ctx, Fragment fragment);
	protected abstract void onActivityResult(int requestCode, int resultCode, Intent data, Context context, Fragment fragment);
}
