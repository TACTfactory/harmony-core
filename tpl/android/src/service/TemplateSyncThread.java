...
import com.tactfactory.mda.test.demact.data.${entity.name?cap_first}SQLiteAdapter;
import com.tactfactory.mda.test.demact.data.${entity.name?cap_first}WebServiceClientAdapter;
import com.tactfactory.mda.test.demact.entity.${entity.name?cap_first};
</#list>
