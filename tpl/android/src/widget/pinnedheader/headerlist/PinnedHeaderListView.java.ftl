...
public class PinnedHeaderListView extends AutoScrollListView
    ...
    private boolean pinnedHeaderEnabled = false;
    ...
    public PinnedHeaderListView(Context context, AttributeSet attrs, int defStyle) {
        ...
        //Force choice mode to single (if not selector doesn't appears)
        //Could be set to CHOICE_MODE_MULTIPLE but that does not make sense
