...
<ruleset name="rule set"
    ...
    <rule ref="rulesets/java/codesize.xml/ExcessiveClassLength">
        <properties>
            <property name="minimum" value="800"/>      <!-- Minimum reporting threshold -->
        </properties>
    </rule>
    <rule ref="rulesets/java/codesize.xml/CyclomaticComplexity">
        <properties>
            ...
            <property name="reportLevel" value="8"/>      <!-- Cyclomatic Complexity reporting threshold -->
        </properties>
    </rule>
    ...
    <rule ref="rulesets/java/codesize.xml/NcssMethodCount">
        <properties>
            <property name="minimum" value="60"/>      <!-- Minimum reporting threshold -->
        </properties>
    </rule>
    ...
    <rule ref="rulesets/java/codesize.xml/TooManyMethods">
        <properties>
            <property name="maxmethods" value="10"/>      <!-- Minimum reporting threshold -->
        </properties>
    </rule>
    ...
    <rule ref="rulesets/java/coupling.xml/ExcessiveImports">
        <properties>
            <property name="minimum" value="20"/>      <!-- Minimum reporting threshold -->
        </properties>
    </rule>
