    ...
    public partial class ${project_name?cap_first}Application : ${project_name?cap_first}ApplicationBase
    {
        ...
        public ${project_name?cap_first}Application()
        {
                ...
                new ${project_name?cap_first}SqlOpenHelperBase())
            {
                ...
                //TODO move to fixture data loader
                /*DeviceProviderUtils deviceProviderUtils = new DeviceProviderUtils(db);
                Device device = deviceProviderUtils.QueryByUdid(GetUdid());
                if (device == null)
                {
                    device = new Device();
                    device.Uuid = GetUdid();
                    device.Sync_uDate = DateTime.Now.AddDays(-1);
                    deviceProviderUtils.Insert(device);
                }*/
            }
        }
