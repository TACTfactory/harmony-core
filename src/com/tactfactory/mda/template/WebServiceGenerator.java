...
public class WebServiceGenerator extends BaseGenerator {
	...
	public WebServiceGenerator(BaseAdapter adapter) throws Exception {
		...
		this.localNameSpace = this.adapter.getNameSpace(this.appMetas.entities.get(0), this.adapter.getData());
		...
		this.datamodel.put(TagConstant.PROJECT_NAME, 		this.appMetas.name);
		this.datamodel.put(TagConstant.PROJECT_NAMESPACE,	this.appMetas.entities.get(0).space);
