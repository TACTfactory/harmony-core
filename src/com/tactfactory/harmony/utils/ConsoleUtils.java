...
public abstract class ConsoleUtils {
    ...
    /** Printer for colors. */
    private static ColoredPrinter cp = new ColoredPrinter(new ColoredPrinterWIN.Builder(0, false).build());
...
//            throw new RuntimeException("Title doesn't not null or empty !!");
    ...
    public static void displaySummary(String title, LinkedHashMap<String, String> commands) {
    ...
    public static Exception launchCommand(
        ...
        try {
            ...
            if (commandPath != null) {
                processBuilder = processBuilder.directory(new File(commandPath));
            }
