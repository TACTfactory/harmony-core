...
public class OrmInitViewTest extends CommonTest {
    ...
    private static final String VIEW_PATH_EDIT_ACTIVITY = VIEW_PATH + "%s/%sEditActivity.java";
    private static final String VIEW_PATH_EDIT_FRAGMENT = VIEW_PATH + "%s/%sEditFragment.java";
    private static final String VIEW_PATH_SHOW_ACTIVITY = VIEW_PATH + "%s/%sShowActivity.java";
    private static final String VIEW_PATH_SHOW_FRAGMENT = VIEW_PATH + "%s/%sShowFragment.java";
    private static final String VIEW_PATH_LIST_ACTIVITY = VIEW_PATH + "%s/%sListActivity.java";
    private static final String VIEW_PATH_LIST_FRAGMENT = VIEW_PATH + "%s/%sListFragment.java";
    ...
    private static final String LAYOUT_PATH_EDIT_ACTIVITY = LAYOUT_PATH + "activity_%s_edit.xml";
    private static final String LAYOUT_PATH_EDIT_FRAGMENT = LAYOUT_PATH + "fragment_%s_edit.xml";
    private static final String LAYOUT_PATH_SHOW_ACTIVITY = LAYOUT_PATH + "activity_%s_show.xml";
    private static final String LAYOUT_PATH_SHOW_FRAGMENT = LAYOUT_PATH + "fragment_%s_show.xml";
    private static final String LAYOUT_PATH_LIST_ACTIVITY = LAYOUT_PATH + "activity_%s_list.xml";
    private static final String LAYOUT_PATH_LIST_FRAGMENT = LAYOUT_PATH + "fragment_%s_list.xml";
    private static final String LAYOUT_PATH_ROW = LAYOUT_PATH + "row_%s.xml";
