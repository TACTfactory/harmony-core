...
public class EmptyBundleGenerationTest extends CommonTest {
    ...
    private static final String BUNDLE_NAMESPACE = "com.tactfactory.harmony.bundles.namespace";
    ...
    public final void testBundleGeneration() {
        EmptyBundleGenerationTest.hasFindFile("annotation/" + BUNDLE_NAME + ".java");
        EmptyBundleGenerationTest.hasFindFile("generator/" + BUNDLE_NAME + "Generator.java");
        EmptyBundleGenerationTest.hasFindFile("parser/" + BUNDLE_NAME + "Parser.java");
        EmptyBundleGenerationTest.hasFindFile("meta/" + BUNDLE_NAME + "Metadata.java");
        EmptyBundleGenerationTest.hasFindFile("command/" + BUNDLE_NAME + "Command.java");
