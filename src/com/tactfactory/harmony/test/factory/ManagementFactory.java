...
public class ManagementFactory extends ProjectMetadataFactory {
	...
	public static ApplicationMetadata generateTestMetadata() {
		...
		// Entities
		EntityMetadata address = 
				ManagementFactory.addEntity("Address", management);
		
		EntityMetadata company = 
				ManagementFactory.addEntity("Company", management);
		
		EntityMetadata person = 
				ManagementFactory.addEntity("Person", management);

		EntityMetadata worker = 
				ManagementFactory.addEntity("Worker", management);

		EntityMetadata manager = 
				ManagementFactory.addEntity("Manager", management);

		EntityMetadata day = 
				ManagementFactory.addEntity("Day", management);

		EntityMetadata furniture = 
				ManagementFactory.addEntity("Furniture", management);

		EntityMetadata tv = 
				ManagementFactory.addEntity("TV", management);

		EntityMetadata projector = 
				ManagementFactory.addEntity("Projector", management);
