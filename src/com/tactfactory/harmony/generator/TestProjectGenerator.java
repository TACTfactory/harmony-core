...
public class TestProjectGenerator extends BaseGenerator<IAdapter> {
    ...
    public final boolean makeProject() {
        ...
        List<IUpdater> updaters = this.getAdapter().getAdapterProject().getTestProjectFilesToClear();
        this.processUpdater(updaters);

        // create libs folder
        updaters = this.getAdapter().getAdapterProject().getTestProjectCreateFolders();
        this.processUpdater(updaters);

        updaters = this.getAdapter().getAdapterProject().getTestProjectFiles();
        this.processUpdater(updaters);

        updaters = this.getAdapter().getAdapterProject().getTestProjectLibraries();
        this.processUpdater(updaters);
